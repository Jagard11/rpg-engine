# ./DatabaseSetup/createCharacterSpellSlotSchema.py
...
def create_character_spell_slot_schema():
    """Create the character spell slots table schema"""
    try:
        ...
        logger.info(f"Creating character spell slot schema in database: {db_path}")
        ...
        # Commit changes
        conn.commit()
        logger.info("Character spell slot schema creation completed successfully.")
...
def main():
    ...
    create_character_spell_slot_schema()
